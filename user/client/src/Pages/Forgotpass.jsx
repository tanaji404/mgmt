  ...
  return (
    <>
      ...
      <div className="register_box">
        <div className="register_left forgotContainer">
...
<div className="register_container">
      <div className="register_box">
        <div className="register_left">
          <h2>Enter OTP</h2>
          <p style={{color:"blue",marginTop:"20px"}}>OTP sent to <span style={{color:"red"}}>{user.email}</span>  for verification</p>
          ...
          <div className="alreadyAcc">
            <p className="P_already"></p>
             ...
             <p>
                ...
                {otpCountdown === 0 && (
                  <h5  style={{color:"blue"}} onClick={handleResendOtp}>Resend OTP</h5>
                )}
          </div>
        </div>
